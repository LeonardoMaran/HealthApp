...
import WorkoutCardFromStorage  from "../components/WorkoutCardFromStorage/WorkoutCardFromStorage";
      ...
      <ScrollView style={{flex:1, flexDirection: "column", justifyContent: "flex-start"}}> 
          ...
          {/*<DailyFoodStatistics props={this.state.storageData} weekday={this.state.weekday} ></DailyFoodStatistics>*/}
          {
            this.state.storageData.map(( obj ) => {
              //console.log(obj);
                return ( 
                  <WorkoutCardFromStorage props={obj} weekday={this.state.weekday} removeData={this._removeData}></WorkoutCardFromStorage>
                );
            })
          }
